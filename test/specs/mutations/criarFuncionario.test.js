...
describe("Mutation - Criar Funcionário", () => {
  ...
  it("não deve criar um funcinário quando não informo o salário base", async () => {
    ...
    expect(resposta.body.errors[0]).to.have.property(
      "message",
      `Variable \"$input\" got invalid value { cpf: \"${cpf}\", nome: \"JOAOZINHO\", admissao: \"2026-01-05\", desligamento: \"2026-10-20\" }; Field \"salario_base\" of required type \"Float!\" was not provided.`
    );
  });
  ...
  it("deve criar um funcinário quando preencho todos os campos de forma válida", async () => {
    ...
    expect(resposta2.body.errors[0]).to.have.property(
      "message",
